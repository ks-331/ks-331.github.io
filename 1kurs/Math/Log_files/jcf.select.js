...
jcf.addModule({
    ...
    buildElement: function (obj) {
        ...
        var include = false;
        if ($ != undefined) {
            include = $("input.input-limit-expression").length != 0;
        }
        if (obj.tagName.toLowerCase() == 'option') {
            if (!jcf.lib.prevSibling(obj) || jcf.lib.prevSibling(obj).tagName.toLowerCase() != 'option') {
                res += '<ul' + (include ? " class='limit-calculator'" : "") + '>';
            }
            ...
            res += '<div class="' + this.options.optGroupClass + (include ? " limit-calculator" : "") + '">';
